...
import net.iquesoft.project.iQueCommerce.presentation.presenter.WishListProductPresenter;
...
public class WishListProductFragment extends BaseFragment implements SelectedProductView {

    @Inject
    WishListProductPresenter presenter;
