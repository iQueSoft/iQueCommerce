...
public class LogOutUseCase extends UseCase {
    ...
    @Inject
    public LogOutUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, CustomerProvider customerProvider) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.customerProvider.logOut();
    }
}
